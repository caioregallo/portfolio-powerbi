...
**Visão Cliente**
![Visão cliente](./images/pagina-1-visao-cliente.png)

**Comportamento de Compra**
![Comportamento de compra](./images/pagina-2-comportamento-compra.png)

**Performance das Campanhas**
![Performance das campanhas](./images/pagina-3-performance-campanhas.png)

**Padrões por Ponto de Venda**
![Padrões por ponto de venda](./images/pagina-4-padroes-ponto-venda.png)
